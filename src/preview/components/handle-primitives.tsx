...
export function CornerHandle({
	...
	return (
		...
		>
			<div
				className="rounded-full bg-[#0099ff] shadow-sm border border-white"
...
export function CircleHandle({
	...
	return (
		...
		>
			<div
				className={cn("rounded-full border border-white shadow-sm", isSelected ? "bg-primary" : "bg-[#0099ff]")}
...
export function IconHandle({
	...
	return (
		<HandleButton
			...
			className="rounded-full bg-[#0099ff] text-white shadow-sm border border-white"
			onPointerDown={onPointerDown}
			onPointerMove={onPointerMove}
			onPointerUp={onPointerUp}
		>

...
export function PreviewToolbar({
	...
	return (
		<div className="grid grid-cols-[1fr_auto_1fr] items-center h-10 px-4 border-t border-border/50">
			<TimecodeDisplay />
			<PlayPauseButton />
			<div className="justify-self-end flex items-center gap-2">
				...
				<Button variant="text" onClick={onToggleFullscreen} className="[&_svg]:size-4">

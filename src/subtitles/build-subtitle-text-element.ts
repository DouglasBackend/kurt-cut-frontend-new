...
function resolveSubtitleStyle({
	...
	stroke: NonNullable<SubtitleStyleOverrides["stroke"]>;
	karaoke: NonNullable<SubtitleStyleOverrides["karaoke"]>;
} {
	const fontSize =
	...
	return {
		...
		stroke: {
			enabled: style?.stroke?.enabled ?? false,
			color: style?.stroke?.color ?? "#000000",
			width: style?.stroke?.width ?? 2,
		},
		karaoke: {
			enabled: style?.karaoke?.enabled ?? false,
			highlightColor: style?.karaoke?.highlightColor ?? "#00ff00",
			baseColor: style?.karaoke?.baseColor ?? "#555555",
		},
	};
}
...
export function buildSubtitleTextElement({
	...
	return {
		...
		...(caption.style?.animations ? { animations: caption.style.animations } : {}),
		params: {
			...
			"stroke.enabled": style.stroke?.enabled ?? false,
			"stroke.color": style.stroke?.color ?? "#000000",
			"stroke.width": style.stroke?.width ?? 2,
			"karaoke.enabled": style.karaoke?.enabled ?? false,
			"karaoke.highlightColor": style.karaoke?.highlightColor ?? "#00ff00",
			"karaoke.baseColor": style.karaoke?.baseColor ?? "#555555",

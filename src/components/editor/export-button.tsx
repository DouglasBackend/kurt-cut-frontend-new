		...
		>
			<PopoverTrigger asChild>
				<button
					type="button"
					className={cn(
						"flex items-center gap-1.5 rounded-lg px-4 py-1.5 text-white text-[0.82rem] font-medium",
						"bg-gradient-to-r from-[#9333EA] to-[#EC4899]",
						"shadow-[0_1px_3px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.15)]",
						"hover:shadow-[0_0_12px_rgba(236,72,153,0.5),inset_0_1px_0_rgba(255,255,255,0.15)]",
